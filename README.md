...
- **บิล** — บิลประจำเดือน (ค่าไฟ, ค่าเน็ต, สมาชิกรายเดือน ฯลฯ) พร้อมยอดและ
  วันครบกำหนดของ**เดือนถัดไป** และติ๊กเมื่อจ่ายแล้ว
...
5. **บิล (`/bills`)** — เพิ่มบิลประจำเดือน (ชื่อ, ประเภท, ยอด, วันครบกำหนด) →
   ดูยอดรวมและวันที่ต้องจ่ายของ**เดือนถัดไป** และติ๊กเมื่อจ่ายแล้ว
6. **การลงทุน (`/investments`)** — เพิ่มสินทรัพย์ (จำนวนหน่วย/ต้นทุน/ราคาปัจจุบัน) →
   เห็นกำไร-ขาดทุนและสัดส่วนพอร์ต
7. **ทรัพย์สิน (`/assets`)** — ใส่มูลค่าซื้อ + อายุการใช้งาน → ระบบคำนวณค่าเสื่อมและมูลค่าปัจจุบัน
8. **รายงาน (`/reports`)** — เลือกปี → กราฟแนวโน้มรายเดือน + ปุ่ม **ดาวน์โหลด CSV**
9. **วางแผน (`/planning`)** — ตั้งงบต่อหมวด (เกินงบจะเตือน) และตั้งเป้าหมายการออม
10. **โปรไฟล์ (`/profile`)** — เปลี่ยนธีม (ผูกกับบัญชี), เปลี่ยนรหัสผ่าน, ออกจากระบบ
11. **ติดตั้งเป็นแอป** — บนมือถือ/Chrome กด “ติดตั้งแอป” เพื่อเพิ่มลงหน้าจอ (PWA)
